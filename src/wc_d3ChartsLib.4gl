...
--
-- API:
-- LET wc_d3ChartsLib.m_d3_clicked = FUNCTION <your click function>    This is optional
-- CALL wc_d3ChartsLib.wc_d3_init
-- CALL wwc_d3ChartsLib.c_d3_setData passing an array of type t_d3_rec to supply the data
--
...
FUNCTION wc_d3_init(l_w SMALLINT, l_h SMALLINT, l_titl STRING) RETURNS ()
	LET m_height = l_h
	LET m_width = l_w
	LET m_title = l_titl
...
END FUNCTION
--------------------------------------------------------------------------------
FUNCTION wc_d3_setData(l_d3_arr DYNAMIC ARRAY OF t_d3_rec) RETURNS ()
...
PRIVATE FUNCTION arrToJsonStr() RETURNS STRING
...
PRIVATE FUNCTION dummyClick(x SMALLINT) RETURNS ()
	MESSAGE "Clicked: ", x
END FUNCTION
